...
| `shifts` | IncidentManagementOncallShiftConnection | Blocks of time for which a participant is on-call. |
...
A block of time for which a user is on-call..

| Field | Type | Description |
| ----- | ---- | ----------- |
| `endsAt` | Time | End time of the on-call shift. |
| `participant` | OncallParticipantType | Participant assigned to the on-call slot. |
