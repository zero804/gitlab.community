  ...
  class ClusterReindexingService
    ...
    def initial!
      ...
      if Elastic::DataMigrationService.pending_migrations?
        abort_reindexing!('Your have unapplied advanced search migrations. Please wait until it is finished')
        return false
      end
      ...
      expected_free_size = alias_names.map {|name| elastic_helper.index_size_bytes(index_name: name) }.sum * 2
